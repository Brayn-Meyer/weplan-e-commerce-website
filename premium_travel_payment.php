...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $stmt->execute([$customerId, $bookingReference, $totalPrice, "Premium Experience"]);
        ...
        if (!empty($_SESSION['adventures'])) {
            foreach ($_SESSION['adventures'] as $adv) {
                $stmt = $pdo->prepare("
                    INSERT INTO adventures (
                        booking_id, type, date, participants, price
                    ) VALUES (?, ?, ?, ?, ?)
                ");
                $stmt->execute([
                    $bookingId,
        ...
        $bookingDetails = [
            ...
            'package' => "Premium Experience",
            'flight_details' => isset($_SESSION['flight']) ? $_SESSION['flight'] : null,
            'accommodation_details' => isset($_SESSION['accommodation']) ? $_SESSION['accommodation'] : null,
            'adventure_details' => !empty($_SESSION['adventures']) ? $_SESSION['adventures'] : null,
            'transport_details' => isset($_SESSION['transport']) ? $_SESSION['transport'] : null
        ];
...
<body>
    <section class="booking-section">
        ...
        <div class="review-summary">
            <p><strong>Package:</strong> Premium Experience</p>
