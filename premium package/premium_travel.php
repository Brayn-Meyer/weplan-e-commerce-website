...
<form id="bookingForm" action="premium package/premium_travel_booking.php" method="post" autocomplete="off">
  <div class="booking-steps">
    ...
    <div class="step" id="step-indicator-2"><span>3</span><p>Adventures</p></div>
    <div class="step" id="step-indicator-3"><span>4</span><p>Transport</p></div>
  </div>
