...
<body>
    <section class="booking-section">
        <h1>✅ Thank you for submitting your issue, <span><?= htmlspecialchars($user['first_name']) ?></span>!</h1>
        <div class="contact-summary">
            ...
            <p>We will contact you via <?= htmlspecialchars($user['email']) ?>, and get back to you as soon as the issue is resolved. Have a nice day.</p>
        </div>
