...
<form id="bookingForm" action="essential package/essential_travel_booking.php" method="post" autocomplete="off">
  ...
  <!-- <div id="step-1" class="form-step" style="display:none;">
    <?php // include "accomodation_info.php"; ?>
  </div>
  <div id="step-2" class="form-step" style="display:none;">
    <?php // include "adventure_info.php"; ?>
  </div>
  <div id="step-3" class="form-step" style="display:none;">
    <?php // include "transport_info.php"; ?>
  </div> -->
