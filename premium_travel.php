...
<form id="bookingForm" action="premium_travel_booking.php" method="post" autocomplete="off">
  ...
  <div class="progress-tracker">
    ...
    <div class="progress-step" id="step-indicator-1">
      <div class="progress-label">Accommodation</div>
    </div>
    
    <div class="progress-step" id="step-indicator-2">
      <div class="progress-label">Adventures</div>
    </div>
    
    <div class="progress-step" id="step-indicator-3">
      <div class="progress-label">Transport</div>
    </div>
  </div>
  ...
  <div id="step-2" class="form-step" style="display:none;">
    <?php include "package-components/adventure_info.php"; ?>
  </div>
  <div id="step-3" class="form-step" style="display:none;">
    <?php include "package-components/transport_info.php"; ?>
  </div>
